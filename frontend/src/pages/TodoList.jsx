        ...
        <div className="max-w-2xl mx-auto">
          <div className="flex justify-end mb-6">
            <button
              ...
              className="bg-linear-to-r from-pink-500 to-red-500 text-white px-5 py-2 rounded-xl font-medium shadow-md hover:shadow-lg transform hover:scale-105 transition text-sm sm:text-base"
            >
              Logout
            </button>
          </div>
          ...
          <div className="mb-8 bg-white rounded-2xl shadow-lg p-6 flex flex-col sm:flex-row gap-4">
            <div className="flex flex-col gap-3 sm:w-3/4 w-full">
              <input
                ...
                className={`w-full px-4 py-3 rounded-xl border-2 transition text-gray-800 focus:outline-none ${
                  titleError
              ...
              <input
                ...
                className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 focus:outline-none focus:border-purple-500 transition text-gray-800"
              />
            ...
            <div className="flex justify-center items-center sm:w-1/4 w-full">
              <button
                onClick={addTodo}
                className="bg-linear-to-r from-indigo-600 to-purple-600 text-white w-full sm:w-auto px-6 py-3 rounded-xl hover:shadow-lg transform hover:scale-105 transition flex items-center justify-center gap-2 font-medium"
              >
                <Plus size={20} />
                Add
              </button>
              ...
              todos.map((todo) => (
                ...
                >
                  <div className="flex items-start sm:items-center justify-between gap-4 flex-wrap">
                    <div className="flex items-start sm:items-center gap-4 flex-1 min-w-[200px]">
                      <button
                      ...
                      <div className="flex flex-col">
                        <span
                          className={`text-lg wrap-break-word ${
                            todo.completed
